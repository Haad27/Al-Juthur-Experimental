...
<svg width="${size}" height="${size}" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
  <defs>
    ...
    <radialGradient id="aljuthur-glow" cx="50%" cy="55%" r="48%">
      <stop offset="0%" stop-color="#C4A574" stop-opacity="0.14"/>
  ...
  <g transform="translate(10, 10) scale(0.8)">
    ...
    <!-- Inner Raised Pages (Warm Ivory/Cream against dark background) -->
    ...
    <!-- Inner Calligraphic Script Hint Lines -->
    ...
    <!-- Organic Roots Tendrils (Golden Amber) -->

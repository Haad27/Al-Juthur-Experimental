          ...
          {messages.map((msg, idx) => (
            ...
            >
              ...
              >
                ...
                {msg.isScopeInvalid && (
                  <div className="flex items-center gap-2 pb-2 mb-3 border-b border-accent/25 text-xs font-bold text-accent uppercase tracking-wider">
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-in fade-in duration-200">
      ...
      <div className="relative w-full max-w-2xl max-h-[85vh] flex flex-col rounded-2xl sm:rounded-3xl border border-border bg-background shadow-2xl overflow-hidden z-10 animate-in zoom-in-95 duration-200">
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-4 custom-scrollbar">
          ...
          {currentBot.warning && (
            <div className="rounded-xl bg-accent/10 border border-accent/25 p-4 space-y-1.5">
          ...
          <div className="rounded-xl bg-card border border-border p-4 space-y-2.5">
            ...
            <div className="pt-2.5 border-t border-border space-y-2">
              <div className="text-[11px] text-reading flex items-start gap-1.5 leading-relaxed">
                <AlertCircle className="size-3.5 shrink-0 mt-0.5 text-accent" />
                <span>
                  <strong className="text-foreground">AI Generation & Hallucination Notice:</strong> Answers are generated by artificial intelligence and can hallucinate or contain inaccuracies. Always remember to cross-check and verify information from the cited classical sources provided with every response.
                </span>
              </div>
          ...
          <div className="rounded-xl bg-card border border-border p-4 space-y-2.5">
            ...
            <ul className="space-y-1.5 text-xs text-reading">
              ...
              <li className="flex items-start gap-2">
                <span className="size-1.5 rounded-full bg-accent shrink-0 mt-1.5" />
                <span>
                  <strong className="text-foreground">Cross-Check Citations:</strong> Because answers are generated by AI, hallucination is possible. Always review and cross-check the claims with the cited sources and referenced source chunks.
                </span>
              </li>
            </ul>
          </div>

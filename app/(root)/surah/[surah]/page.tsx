      ...
      <div className="flex flex-col w-full min-h-screen blg:px-24 bpx-4">
        ...
        {!loading &&
          ...
          ayahs.map((ayah) => (
            ...
            >
              <div
                className="h-full flex flex-row sm:order-1 order-2 sm:flex-col gap-3 sm:justify-center items-center transition-all duration-300"
              >
              ...
              <div
                className="text-right sm:order-2 order-1 flex flex-col w-full"
              >
                <p
                  lang="ar"
